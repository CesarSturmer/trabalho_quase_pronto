...
public class InstituicaoControl {
    ...
    // Create 
    public boolean Cadastrar(String area, String descricao, String nome, String endereco, String telefone) throws SQLException {
        ...
        Instituicao objeto = new Instituicao(area, descricao, id, nome, endereco, telefone);
    ...
    // Update
    public boolean Editar(String area, String descricao, int id, String nome, String endereco, String telefone) {
        Instituicao objeto = new Instituicao(area, descricao, id, nome, endereco, telefone);
    ...
    public String[][] getMinhaMatrizTexto() {
        ...
        String MatrizInstituicao[][] = new String[tamanho][6];
